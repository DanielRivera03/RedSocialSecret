<?php
   ...
   if($_GET['publicaciones']!="explorar-amigos-aceptados"){
      header('location:../AccesoDenegado=restringido');
   }
      ...
      <div class="wrapper">
         ...
         <div class="header-for-bg">
            <div class="background-header position-relative">
               <img src="../vista/images/bg_portadaamigos.jpg" class="img-fluid w-100 dimension_portada" alt="header-bg">
                                 ...
                                 <div class="profile-info p-4">
                                    <div class="user-detail">
                                       <div class="d-flex flex-wrap justify-content-between align-items-start">
                                          ...
                                          <!-- ELIMINAR AMIGOS --> 
                                          <a style="color: var( --iq-white);" id="borraramigo" data-id="'.$filas['idamigo'].'" class="btn btn-primary"><i class="fa fa-trash"></i> Eliminar</a>
                                          <!-- VISTA DE PERFILES -->
                                          <a href="../controlador/cPublicacionesUsuarios.php?publicaciones=perfil-general&usuario='; echo $filas['usuario']; echo'&id='; echo $filas['idsolicitudamigo']; echo'" class="btn btn-primary"><i class="fa fa-external-link"></i> Ver Perfil</a>'; } echo'
                                       </div>
                                    </div>
                                 </div>
                              </div>
