...
<html lang="ES-SV">
   <head>
      ...
      <title>Secret - Perfil Incompleto</title>
      <!-- Favicon -->
                ...
                <div class="row no-gutters">
                    <div class="col-sm-12 text-center">
                        <div class="iq-error position-relative mt-5">
                            <img src="vista/images/error/01.png" class="img-fluid iq-error-img" alt="">
                            <h1 class="text-in-box">&#128530; NO</h1>
                            <h2 class="mb-0">Perfil Incompleto</h2>
                            <p style="font-size: 1.05rem;">Lo sentimos, lamentablemente el due&ntilde;o de este perfil no ha completado la secci&oacute;n requerida para que su perfil pueda ser visualizado por todos los usuarios...</p>
                            <a class="btn btn-primary mt-3" href="Amigos/explorar-amigos"><i class="fa fa-hand-o-left"></i>Regresar P&aacute;gina Anterior</a>                            
                        </div>
                    </div>
                </div>
            </div>
