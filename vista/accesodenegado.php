...
<html lang="ES-SV">
   <head>
      ...
      <title>Secret - Acceso Denegado</title>
      <!-- Favicon -->
                ...
                <div class="row no-gutters">
                    <div class="col-sm-12 text-center">
                        <div class="iq-error position-relative mt-5">
                            ...
                            <h2 class="mb-0">Lo sentimos, usted no tiene permiso para ver esta p&aacute;gina.</h2>
                            <p>Por favor inicie sesi&oacute;n.</p>
                            <a class="btn btn-primary mt-3" href="IniciarSesion/inicio"><i class="ri-home-4-line"></i>Regresar Al Inicio</a>                            
                        </div>
                    </div>
                </div>
            </div>
